...
var PRODUCTS = [
  {id:1, name:"iPhone 13 128GB Midnight - Garansi Resmi iBox", cat:"Elektronik", price:9499000, old:10999000, rating:4.9, sold:"10RB+", stock:25, mall:true, flash:true, img:"https://images.pexels.com/photos/788946/pexels-photo-788946.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Chip A15 Bionic, kamera ganda 12MP, baterai tahan seharian. Garansi resmi 1 tahun.", varian:["Midnight","Starlight","Blue"]},
  {id:2, name:"Sepatu Running Pria Breathable - Ringan dan Empuk", cat:"Olahraga", price:249000, old:499000, rating:4.8, sold:"25RB+", stock:120, mall:true, flash:true, img:"https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=500&q=80", desc:"Mesh breathable, sol anti-slip, cocok untuk lari harian dan gym.", varian:["Hitam","Putih","Navy"]},
  {id:3, name:"Skincare Brightening Serum Niacinamide 10% 20ml", cat:"Kecantikan", price:89000, old:159000, rating:4.9, sold:"50RB+", stock:300, mall:true, flash:true, img:"https://images.pexels.com/photos/30968097/pexels-photo-30968097.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Mencerahkan dalam 14 hari, BPOM, cocok semua jenis kulit.", varian:["20ml","30ml"]},
  {id:4, name:"Kaos Oversize Cotton Combed 30s Premium", cat:"Fashion", price:59000, old:129000, rating:4.7, sold:"30RB+", stock:500, mall:false, flash:true, img:"https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=500&q=80", desc:"Bahan adem, sablon plastisol awet, size M-XXL.", varian:["Hitam","Putih","Cream","Sage"]},
  {id:5, name:"Kopi Susu Gula Aren 1 Liter - Fresh Setiap Hari", cat:"Makanan", price:45000, old:65000, rating:4.8, sold:"15RB+", stock:80, mall:false, flash:false, img:"https://images.pexels.com/photos/29621585/pexels-photo-29621585.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Espresso double shot + susu full cream + aren asli.", varian:["Less Sugar","Normal","Extra Shot"]},
  {id:6, name:"Laptop Gaming RTX 4050 16/512GB 144Hz", cat:"Elektronik", price:14499000, old:16999000, rating:4.9, sold:"2RB+", stock:12, mall:true, flash:false, img:"https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=500&q=80", desc:"Ryzen 7 + RTX 4050, layar 144Hz, garansi 2 tahun.", varian:["16/512","32/1TB"]},
  {id:7, name:"Tas Selempang Wanita Kulit Premium Anti Air", cat:"Fashion", price:129000, old:259000, rating:4.6, sold:"8RB+", stock:90, mall:false, flash:false, img:"https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=500&q=80", desc:"Kulit sintetis grade A, tali adjustable, muat HP + dompet.", varian:["Coklat","Hitam","Beige"]},
  {id:8, name:"Air Fryer 5L Low Watt - Tanpa Minyak", cat:"Rumah", price:649000, old:1299000, rating:4.8, sold:"12RB+", stock:45, mall:true, flash:true, img:"https://images.pexels.com/photos/29461935/pexels-photo-29461935.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"8 menu otomatis, timer digital, garansi 1 tahun.", varian:["Hitam","Putih"]},
  {id:9, name:"Boneka Beruang Jumbo 1 Meter Super Lembut", cat:"Ibu & Bayi", price:99000, old:199000, rating:4.7, sold:"5RB+", stock:60, mall:false, flash:false, img:"https://images.pexels.com/photos/708774/pexels-photo-708774.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Bahan yelvo lembut, isian dakron full, aman untuk anak.", varian:["Coklat","Pink","Cream"]},
  {id:10, name:"Jam Tangan Smartwatch AMOLED 1.85 inci Bluetooth Call", cat:"Elektronik", price:349000, old:799000, rating:4.7, sold:"20RB+", stock:150, mall:true, flash:true, img:"https://images.unsplash.com/photo-1546868871-7041f2a55e12?auto=format&fit=crop&w=500&q=80", desc:"AMOLED 1.85 inci, monitor jantung + SpO2, baterai 7 hari.", varian:["Hitam","Silver"]},
  {id:11, name:"Paket Skincare Glow Up 5in1 - Untuk Pemula", cat:"Kecantikan", price:149000, old:299000, rating:4.8, sold:"18RB+", stock:200, mall:true, flash:false, img:"https://images.pexels.com/photos/15569178/pexels-photo-15569178.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Facial wash, toner, serum, moisturizer, sunscreen.", varian:["Normal","Acne","Bright"]},
  {id:12, name:"Dumbbell Set 20kg - Bisa Bongkar Pasang", cat:"Olahraga", price:329000, old:549000, rating:4.8, sold:"7RB+", stock:70, mall:false, flash:false, img:"https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=500&q=80", desc:"Plat besi lapis karet, handle anti-slip.", varian:["10kg","20kg","30kg"]},
  {id:13, name:"Beras Premium 5kg - Pulen dan Wangi", cat:"Makanan", price:68000, old:85000, rating:4.6, sold:"40RB+", stock:400, mall:false, flash:false, img:"https://images.pexels.com/photos/36346840/pexels-photo-36346840.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Panen baru, tanpa pemutih, langsung dari petani.", varian:["5kg","10kg"]},
  {id:14, name:"Kemeja Linen Pria Lengan Panjang - Adem", cat:"Fashion", price:119000, old:229000, rating:4.7, sold:"9RB+", stock:110, mall:false, flash:false, img:"https://images.pexels.com/photos/28576622/pexels-photo-28576622.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Linen premium, jahitan rapi, size S-XXL.", varian:["Putih","Sage","Navy","Hitam"]},
  {id:15, name:"Vacuum Cleaner Mini Portable Wireless", cat:"Rumah", price:189000, old:399000, rating:4.6, sold:"11RB+", stock:85, mall:true, flash:true, img:"https://images.pexels.com/photos/3616746/pexels-photo-3616746.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Daya hisap 9000Pa, 3 kepala brush, USB-C fast charging.", varian:["Putih","Grey"]},
  {id:16, name:"Popok Bayi Premium S40 - Extra Dry", cat:"Ibu & Bayi", price:52000, old:78000, rating:4.9, sold:"60RB+", stock:600, mall:true, flash:false, img:"https://images.pexels.com/photos/7491332/pexels-photo-7491332.jpeg?auto=compress&cs=tinysrgb&w=500", desc:"Daya serap 12 jam, anti bocor, hypoallergenic.", varian:["S40","M34","L30"]}
];
